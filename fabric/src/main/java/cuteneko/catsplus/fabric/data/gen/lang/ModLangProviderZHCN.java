...
public class ModLangProviderZHCN extends FabricLanguageProvider {
    ...
    public ModLangProviderZHCN(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    public void generateTranslations(HolderLookup.Provider provider, TranslationBuilder builder) {
        ...
        builder.add(ModConstants.MESSAGE_FANG_LUO_DESCRIPTION_1, "纪念因肿瘤离去的坊洛。");
        builder.add(ModConstants.MESSAGE_FANG_LUO_DESCRIPTION_2, "缅怀……");

        builder.add(ModBlocks.CAT_RESURRECTION_STATION_BLOCK.get(), "猫咪复活台");

        builder.add(ModEffects.CATTIFY.get(), "猫咪化");
        builder.add(ModConstants.MESSAGE_CATTIFY_POTION, "变猫药水");
        builder.add(ModConstants.MESSAGE_CATTIFY_SPLASH_POTION, "喷溅型变猫药水");
        ...
        builder.add(ModConstants.MESSAGE_CAT_SPIRIT_NAME, "%1$s 的灵魂");
        builder.add(ModConstants.MESSAGE_CAT_SPIRIT_DESCRIPTION_MESSAGE, "");
        builder.add(ModConstants.MESSAGE_CAT_SPIRIT_DESCRIPTION_TIME_LABEL, "卒于：");
        builder.add(ModConstants.MESSAGE_CAT_SPIRIT_DESCRIPTION_TIME_PATTERN, "%1$s年%2$s月%3$s日 %4$s:%5$s:%6$s");
        builder.add(ModConstants.MESSAGE_CAT_SPIRIT_DESCRIPTION_TIME_LONG_TIME_AGO, "很久以前");

        builder.add(ModConstants.MESSAGE_CAT_DIED, "你的猫猫死掉了，灵魂回到了主人的身边。");
    }
}
